            ...
            <div className="relative h-[650px] flex items-center" style={{ backgroundImage: `url(${bpoo})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-left">
                    <div className="max-w-4xl">
                         <span className="inline-block mt-20 sm:mt-0 px-4 py-2 rounded-full bg-amber-500/20 text-amber-400 text-sm font-bold uppercase tracking-widest mb-6 border border-amber-500/30 backdrop-blur-md">
