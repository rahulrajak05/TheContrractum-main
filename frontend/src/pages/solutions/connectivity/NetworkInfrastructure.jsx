...
export default function NetworkInfrastructure() {
  const servicesList = [
    { icon: NetworkIcon, title: "Network Design & Architecture", id: "01" },
    { icon: Shuffle, title: "Enterprise Routing & Switching", id: "02" },
    { icon: Layers, title: "Software-Defined Networking (SDN)", id: "03" },
    { icon: ShieldCheck, title: "Network Security & Firewall", id: "04" },
    { icon: Activity, title: "Load Balancing & Traffic Mgmt", id: "05" },
    { icon: Wifi, title: "Wireless Network Solutions", id: "06" },
    { icon: Zap, title: "WAN Optimization & SD-WAN", id: "07" },
    { icon: BarChart4, title: "Network Monitoring & Analytics", id: "08" },
    { icon: Cable, title: "Structural Cabling Solutions", id: "09" },
    { icon: Server, title: "Data Center Networking", id: "10" },
    { icon: PhoneCall, title: "Unified Communications (UC)", id: "11" },
    { icon: Gauge, title: "Network Performance Testing", id: "12" },
    { icon: Lock, title: "VPN & Secure Remote Access", id: "13" },
    { icon: Globe, title: "IP Address Management (IPAM)", id: "14" },
    { icon: Cloud, title: "Virtual Private Cloud (VPC)", id: "15" },
  ];

  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="relative h-[650px] flex items-center" style={{ backgroundImage: `url(${network})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/70 to-transparent"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-left">
          <div className="max-w-4xl">
             <span className="inline-block mt-12 sm:mt-0 px-4 py-2 rounded-full bg-amber-500/20 text-amber-400 text-sm font-bold uppercase tracking-widest mb-6 border border-amber-500/30 backdrop-blur-md">
              Enterprise Network Infrastructure
            </span>
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black mb-8 leading-tight text-white drop-shadow-2xl">
              Reliable <span className="text-cyan-500">Infrastructure</span> for Modern Business
            </h1>
            <p className="text-gray-200 text-lg sm:text-xl mb-10 leading-relaxed max-w-3xl drop-shadow-2xl font-medium">
              TheContractum designs and builds robust network foundations that power high-speed data transfer, seamless communication, and enterprise-grade security across your entire organization.
            </p>
            <div className="flex gap-4 flex-wrap">
              ...
              <Link
                to="/solutions/download?service=network"
      ...
      <div className="bg-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 mb-6">Network Engineering Portfolio</h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start gap-5 relative z-10">
                    <div className="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-cyan-500 to-teal-600 rounded-xl shadow-lg flex items-center justify-center text-white transform group-hover:rotate-6 transition-transform">
                      <Icon size={28} />
                    </div>
                    <div>
                      <div className="text-cyan-600 font-bold text-xs uppercase mb-1">SERVICE {service.id}</div>
                      <h3 className="text-lg font-bold text-slate-900 group-hover:text-cyan-700 transition-colors">{service.title}</h3>
                    </div>
                  </div>
                </div>
              );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 mb-8 leading-tight">
                Engineering Connectivity for the Enterprise
              </h2>

              <div className="space-y-6">
                {[
                  "State-of-the-art routing and switching fabrics",
                  "Comprehensive network security and threat management",
                  "High-density wireless and unified communications",
                  "Optimized WAN and software-defined network solutions"
                ].map((item, idx) => (
      ...
      <div className="bg-slate-900 relative py-20 lg:py-32 overflow-hidden text-white">
        <div className="absolute top-0 left-0 w-full h-full opacity-25">
          ...
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-teal-600 rounded-full blur-[150px]"></div>
        </div>

        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black mb-8">
            Build Your <span className="text-cyan-500">Secure Network</span>
          </h2>

          <p className="text-gray-400 text-lg sm:text-xl mb-12 max-w-2xl mx-auto leading-relaxed">
            Joining hands with our network engineering team ensures your mission-critical operations are powered by a reliable and high-performance infrastructure.
          </p>
      ...
      <DynamicServices category="Connectivity Solutions" subCategory="Network Infrastructure" />
    </div>
  );
}